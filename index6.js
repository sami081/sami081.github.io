...
function clickOnBallon(bubble) {
  if (!gameOver && bubble.textContent<20*11) {
    ...
    if (counter >= 50) { // Le chiffre de ballon a atteindre doit être dans une constante au dessus
      gameOver = true;
      text.innerHTML = `
      <h3>Gagné</h3>
      <ul>
      <li><a href="./index7.html">Passez au niveau 7</a></li>
